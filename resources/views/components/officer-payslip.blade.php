    ...
    <div id="printable">
        ...
        <div style="font-size:13px">
            <div class="text-right" style="display: inline-block; width: 7%">
                <img class="text-center" src="{{asset('assets/bucketcodes/image/pension-logo.png')}}" style="width:4rem; margin-right: 10px">
            </div>
            <div class="text-left" style="display: inline-block; width: 61%">
                <h4 style="font-size: 2rem">{{config('app.name')}}</h4>
            </div>
