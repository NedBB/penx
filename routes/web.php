...
})->middleware(['auth', 'verified'])->name('payment-schedule');

Route::get('/contributory/pension', function () {
    return view('queries.contributory-pension');
})->middleware(['auth', 'verified'])->name('contributory-pension');
